...
Ini adalah API Student Portal, pada API ini memiliki endpoint seperti register, login, logout, get All Data Class, fetch By ID, add data student, update data student, delete data student, get data student with class. API ini juga sudah terintegrasi dengan database PostgreSQL

# Dokumentasi API Student Portal

Dokumentasi API Student Portal bisa dilihat : [disini](https://documenter.getpostman.com/view/26190643/2s9YkgDk22)
